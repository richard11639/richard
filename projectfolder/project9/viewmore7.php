...
<head>
  ...
  <title>Penthouse room— View More</title>
...
<body>
  ...
  <main class="container">
    ...
    <section aria-label="Image slider" style="margin-top:18px">
      <div class="slider" id="slider">
        <div class="slides" id="slides">
          <div class="slide">
            <img src="images/image115.jpg" alt="Eko Estate exterior">
            <div class="overlay">family room — Exterior</div>
          </div>
          <div class="slide">
            <img src="images/image116.jpg"
            te — Interior</div>
          </div>
        </div>
    ...
    <section class="hero-home" aria-label="Home hero">
      <img src="images/image165.jpg" alt="Home image">
    </section>

    <!-- View More story -->
    <section id="view-story" class="content" aria-labelledby="view-title">
      <h2 id="view-title">View More — penthouse Estate Story</h2>
    ...
    <section id="rooms" class="rooms" aria-labelledby="rooms-title">
      ...
      <div class="room-grid" style="margin-top:12px">
        ...
        <article class="room-card">
          <img src="images/image115.jpg" alt="family deluxe Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Penthouse deluxe room (Garden)</h3>
            ...
            <p>standard Room with marble floors and a great view of the city with smoking or non-smoking room available</p>
             <a class="btn ghost" href="booking7.php">Book Now</a></div></div> 
          </div>
        </article>
 <!-- Standard Room -->
        <article class="room-card">
          <img src="images/image150.jpg" alt="Standard family Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Standard penthouse Room </h3>
        ...
        <!-- Classic Room -->
        <article class="room-card">
          <img src="images/image117.jpg" alt="executive Superior room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Executive penthouse Room</h3>
 ...
 <!-- Standard Room -->
        <article class="room-card">
          <img src="images/image160.jpg" alt="Diplomatic family suites" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Diplomatic penthouse suites</h3>
