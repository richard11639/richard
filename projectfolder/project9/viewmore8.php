...
<head>
  ...
  <title>Studio room— View More</title>
...
<body>
    ...
    <section aria-label="Image slider" style="margin-top:18px">
      <div class="slider" id="slider">
        <div class="slides" id="slides">
          <div class="slide">
            <img src="images/image117.jpg" alt="Eko Estate exterior">
    ...
    <section id="rooms" class="rooms" aria-labelledby="rooms-title">
      ...
      <div class="room-grid" style="margin-top:12px">
        ...
        <article class="room-card">
          <img src="images/image158.jpg" alt="studio deluxe Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Studio deluxe room (Garden)</h3>
            ...
            <a class="btn ghost" href="booking8.php">Book Now</a></div></div> 
          </div>
        </article>
 <!-- Standard Room -->
        <article class="room-card">
          <img src="images/image157.jpg" alt="Standard studio Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Standard studio Room </h3>
        ...
        <!-- Classic Room -->
        <article class="room-card">
          <img src="images/image164.jpg" alt="executive studio room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Executive sudio Room</h3>
 ...
 <!-- Standard Room -->
        <article class="room-card">
          <img src="images/image150.jpg" alt="Diplomatic studio suites" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
