...
<head>
  ...
  <title>Hotel Pricing — Details</title>
  <style>
    :root{
...
<body>
  <div class="wrap">
    <header>
      <h1>🏨 Hotel Pricing — Room & Service Details</h1>
      <div class="controls">
        <label>
          Season:
          <select id="season">
    ...
    <div class="layout">
      ...
      <main class="panel">
        ...
        <section style="margin-top:18px">
          ...
          <div class="pkg">
            ...
            <div class="rate-pill">Half Board</div>
            <div class="rate-pill">Full Board</div>
      ...
      <aside class="panel">
        ...
        <button class="cta" id="bookBtn">Proceed to Book</button>
        ...
        node.innerHTML = `
          <div class="left">
            ...
            <div style="margin-top:8px" class="pkg">
              ...
              <button class="rate-pill" onclick="selectRoom('${r.id}','Bed & Breakfast')">B&B</button>
              <button class="rate-pill" onclick="selectRoom('${r.id}','Half Board')">Half Board</button>
              <button class="rate-pill" onclick="selectRoom('${r.id}','Full Board')">Full Board</button>
            </div>
          </div>
