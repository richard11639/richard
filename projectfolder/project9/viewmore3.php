...
<head>
  ...
  <title>Executive— View More</title>
...
<body>
  ...
  <main class="container">
    ...
    <section class="hero-home" aria-label="Home hero">
      <img src="images/image161.jpg" alt="Home image">
    </section>

    <!-- View More story -->
    <section id="view-story" class="content" aria-labelledby="view-title">
      <h2 id="view-title">View More — executive Estate Story</h2>
    ...
    <section id="rooms" class="rooms" aria-labelledby="rooms-title">
      ...
      <div class="room-grid" style="margin-top:12px">
        ...
        <article class="room-card">
          <img src="images/image158.jpg" alt="Classic deluxe Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>classic deluxe room (Garden)</h3>
            ...
            <a class="btn ghost" href="booking3.php">Book Now</a></div></div>
          </div>
        </article>
 <!-- Standard Room -->
        <article class="room-card">
          <img src="images/image159.jpg" alt="Standard executive Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Standard executive Room (Garden)</h3>
        ...
        <!-- Classic Room -->
        <article class="room-card">
          <img src="images/image160.jpg" alt="executive Superior room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Executive superior Room</h3>
 ...
 <!-- Standard Room -->
        <article class="room-card">
          ...
          <div class="room-body">
            <h3>Diplomatic executive suites</h3>
            <div class="meta">Room side: <strong>29.68</strong>  —  Bathroom: <strong>6.82</strong></div>
