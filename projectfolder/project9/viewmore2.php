...
<body>
  ...
  <main class="container">
    ...
    <section aria-label="Image slider" style="margin-top:18px">
      <div class="slider" id="slider">
        <div class="slides" id="slides">
          <div class="slide">
            <img src="images/image153.jpg" alt="Eko Estate exterior">
            <div class="overlay">Ocean suite — Exterior</div>
          </div>
          <div class="slide">
            <img src="images/image154.jpg" alt="Eko suite interior">
            <div class="overlay">Ocean suite — Interior</div>
          </div>
        </div>
    ...
    <section class="hero-home" aria-label="Home hero">
      <img src="images/image155.jpg" alt="Home image">
    </section>

    <!-- View More story -->
    <section id="view-story" class="content" aria-labelledby="view-title">
      <h2 id="view-title">View More — Ric Estate Story</h2>
      <p class="lead">All the rooms are well appointed and designed to provide the comfort of human beings.</p>

      <p> Beside the room are well appointed and designed to provide comfort and convenience.beside the usual amenities such as central air conditioning, satellite TV, fast internet connection,
    ...
    <section id="rooms" class="rooms" aria-labelledby="rooms-title">
      ...
      <div class="room-grid" style="margin-top:12px">
        ...
        <article class="room-card">
          <img src="images/image154.jpg" alt="Classic ocean Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>classic ocean suite (Garden)</h3>
            ...
            <a class="btn ghost" href="booking2.php">Book Now</a></div></div>
          </div>
        </article>
 <!-- Standard Room -->
        <article class="room-card">
          <img src="images/image156.jpg" alt="Standard ocean Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Standard ocean Room (Garden)</h3>
        ...
        <!-- Classic Room -->
        <article class="room-card">
          <img src="images/image155.jpg" alt="Atlantic Superior room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
 ...
 <!-- Standard Room -->
        <article class="room-card">
          <img src="images/image157.jpg" alt="Diplomatic suites" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
