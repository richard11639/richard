...
<div class="container">
  <div class="booking-box">
    <form id="bookingForm" method="POST" action="process_booking.php">
      <h2 class="mb-3">Book Your Stay — RIc l & Suites</h2>
      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <select id="roomType" name="room_type" class="form-control" required>
            <option value="Eko Garden|55000">family room(single)— ₦55,000/night</option>
            <option value="Eko Suite|70000">family room(2 room) — 70,000/night</option>
          </select>
        </div>
<!-- Extras -->
        <div class="col-md-12">
