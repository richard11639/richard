...
<head>
  ...
  <title>presidential— View More</title>
...
<body>
  ...
  <main class="container">
    ...
    <section aria-label="Image slider" style="margin-top:18px">
      <div class="slider" id="slider">
        <div class="slides" id="slides">
          <div class="slide">
            <img src="images/image150.jpg" alt="Eko Estate exterior">
            <div class="overlay">presidential room — Exterior</div>
          </div>
          <div class="slide">
    ...
    <section class="hero-home" aria-label="Home hero">
      <img src="images/image130.jpg" alt="Home image">
    </section>
    ...
    <section id="view-story" class="content" aria-labelledby="view-title">
      ...
      <p> Beside the room  and they are soo beautiful and well kept with a high cleaning with good monitor cameral with a well develop bed, and it so expensive are well appointed and designed to provide comfort and convenience.beside the usual amenities such as central air conditioning, satellite TV, fast internet connection,
    ...
    <section id="rooms" class="rooms" aria-labelledby="rooms-title">
      ...
      <div class="room-grid" style="margin-top:12px">
        ...
        <article class="room-card">
          <img src="images/image153.jpg" alt="Presidential deluxe Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Presidential deluxe room (Garden)</h3>
            ...
            <a class="btn ghost" href="booking4.php">Book Now</a></div></div> 
       </div>
        </article>
 <!-- Standard Room -->
        <article class="room-card">
          <img src="images/image152.jpg" alt="Standard presidential Room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Standard presidential Room </h3>
        ...
        <!-- Classic Room -->
        <article class="room-card">
          <img src="images/image159.jpg" alt="executive Superior room" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
 ...
 <!-- Standard Room -->
        <article class="room-card">
          <img src="images/image161.jpg" alt="Diplomatic executive suites" onclick="openModal(this.src)" style="cursor:pointer">
          <div class="room-body">
            <h3>Diplomatic presidential suites</h3>
