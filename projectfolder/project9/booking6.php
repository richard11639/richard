      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <select id="roomType" name="room_type" class="form-control" required>
            <option value="Eko Garden|60000">business twin(single) — ₦60,000/night</option>
            <option value="Eko Suite|75000">business twin(2 room) — ₦75,000/night</option>
            <option value="Presidential|200000">Presidential — ₦200,000/night</option>
          </select>
        </div>
<!-- Extras -->
        <div class="col-md-12">
