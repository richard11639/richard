      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <select id="roomType" name="room_type" class="form-control" required>
            <option value="Eko Garden|250000">Presidential room(single)— ₦250,000/night</option>
            <option value="Eko Suite|350000">Presidential room (2 room) — ₦350,000/night</option>
          </select>
        </div>
<!-- Extras -->
        <div class="col-md-12">
