...
<title>Ric room— View More</title>
...
<header class="site-header">
  <div class="container topbar">
         <a href="index6.php" class="cta-book">home</a>
         <a href="booking1.php" class="cta-book">book</a>
    <div class="brand">
      <h1>Ric room — View More</h1>
...
<main>
  ...
  <section class="hero container" aria-label="Two-image slider">
    <div class="slider" id="slider">
      <div class="slides" id="slides">
        ...
        <div class="slide">
          <img src="images/image150.jpg" alt="Eko Estate exterior at dusk">
          <div class="caption">Ric Estate — Evening Facade</div>
        </div>
        <div class="slide">
  ...
  <section class="container content" id="view-more">
    <h3>About the Rooms — Ric Estate Story</h3>
    <p class="lead">
  ...
  <section class="container rooms" aria-label="Room overview">
    ...
    <div class="room-grid">
      ...
      <article class="room-card">
        <img src="images/image150.jpg" alt="Standard (Garden) Room">
        <div class="room-body">
          <h4>Ric (Garden)</h4>
          ...
          <a class="btn ghost" href="booking1.php">Book Now</a></div></div>
        </div>
      </article>

      <!-- Classic Room -->
      <article class="room-card">
        <img src="images/image151.jpg" alt="Classic Room">
        <div class="room-body">
          <h4>Ric garden(2 room)</h4>
  ...
  <footer class="container footer" aria-label="Contact information">
    <div class="contact">
      <div class="box">
        ...
        <p style="margin:.25rem 0"><strong>Email:</strong> <a href="mailto:reservations@ekohotels.com">Ogundelerichard202@gmail.com</a></p>
      </div>
      <div class="box">
